...
annual_salary_adj_by_loc_and_age = combined.pivot_table(index='_full_city', columns='How old are you?', values='_annual_salary_adjusted', aggfunc='mean')
annual_salary_adj_by_loc_and_age.to_csv('cache/annual_salary_adjusted_by_location_and_age.csv')
annual_salary_adjusted_by_loc_and_edu = combined.pivot_table(index='_full_city', columns='What is your highest level of education completed?', values='_annual_salary_adjusted', aggfunc='mean')
annual_salary_adj_by_loc_and_age.to_csv('cache/annual_salary_adjusted_by_location_and_education.csv')
st.write(annual_salary_adjusted_by_loc_and_edu)
